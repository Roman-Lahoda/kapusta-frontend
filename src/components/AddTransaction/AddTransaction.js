...
import CalculatorIcon from 'components/Calculator/CalculatorIcon/CalculatorIcon';
...
export default function AddTransaction({ onCloseForm }) {
  const { type, picker, handleCalendarClick, closePicker, date } = useContext(contextProps);
