...
//https://capusta2.herokuapp.com/api/transactions/expense
...
//https://capusta2.herokuapp.com/api/transactions/income
...
//   }
// пример запроса
// https://capusta2.herokuapp.com/api/transactions/expense/619026a94ff3aead8b416ea4/?day=10&month=11&year=2021
...
// ДОХОД
// https://capusta2.herokuapp.com/api/transactions/income/619026a94ff3aead8b416ead/?day=11&month=11&year=2021
export async function addIncTransactions(transactions) {
  ...
  const { data } = await axios.post(
    `/api/transactions/income/${transactions.categoryId}/?day=${day}&month=${month}&year=${year}`,
    newTransaction,
  );
  // console.log(data)
  return data.result;
...
// УДАЛЕНИЕ ТРАНЗАКЦИИ
// https://capusta2.herokuapp.com/api/transactions/61944953da2a3c0076d5ebdd
//
