...
import s from './TransactionsListMobile.module.scss';
            ...
            <div key={transaction._id} className={s.firstWrapper}>
              <li className={s.listItem}>
                <div className={s.listItem__wrapper}>
                  <p className={s.listItem__subCategory}>{transaction.subCategory}</p>
                ...
                <div className={s.listItem__sumWrapper}>
                  <p
                    ...
                    style={
                      transaction.type === 'income' ? { color: '#407946' } : { color: '#E7192E' }
                    }
                  >
                ...
                <div className={s.buttonWrapper}>
                  <button className={s.buttonsGroup} onClick={() => handleDeleteClick(transaction)}>
                  ...
                  <button className={s.buttonsGroup} onClick={() => handleEditClick(transaction)}>
                    <svg
                      aria-hidden="true"
                      height="16"
                      viewBox="0 0 16 16"
