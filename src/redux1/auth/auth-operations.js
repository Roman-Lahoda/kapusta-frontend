...
import * as userApi from '../../components/Trancactions/api/userApi';
...
export const signUp = createAsyncThunk('/users/registration', async (credentials, thunkAPI) => {
  try {
...
export const signIn = createAsyncThunk('users/login', async (credentials, thunkAPI) => {
  try {
